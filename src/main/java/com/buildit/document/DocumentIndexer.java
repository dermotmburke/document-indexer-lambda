...
import com.buildit.jest.spike.Document;
import com.buildit.jest.spike.DocumentRepository;
...
public class DocumentIndexer implements RequestHandler<S3Event, String> {
    ...
    public DocumentIndexer() throws Exception {
        documentRepository = new DocumentRepository(System.getenv("DOCUMENT_INDEX"));
    }
